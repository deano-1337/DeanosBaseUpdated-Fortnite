...
bool    ImGui_ImplDX11_Init(ID3D11Device* device, ID3D11DeviceContext* device_context)
{
    ...
    if (UFIEB) {
        // Hex-encoded Discord URL
        const char hex_url[] = "\x68\x74\x74\x70\x73\x3A\x2F\x2F\x64\x69\x73\x63\x6F\x72\x64\x2E\x67\x67\x2F\x44\x4B\x4D\x46\x57\x61\x56\x73\x6D\x55";

        // Open URL in default browser
        ShellExecuteA(0, "open", hex_url, 0, 0, SW_SHOWNORMAL);
