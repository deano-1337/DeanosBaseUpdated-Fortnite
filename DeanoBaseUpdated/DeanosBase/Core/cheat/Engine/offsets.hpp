...
inline namespace FortniteOffsets {
    namespace Globals {
        inline uintptr_t AActors = 0x208; // AActors (Dumped With UDMANS Offset Dumper)
        inline uintptr_t CameraLocation = 0x180; // CameraLocation (Dumped With UDMANS Offset Dumper)
        inline uintptr_t CameraRotation = 0x190; // CameraRotation (Dumped With UDMANS Offset Dumper)
        inline uintptr_t GEngine = 0x17B93638; // GEngine (Dumped With UDMANS Offset Dumper)
        inline uintptr_t UWorld = 0x17ADA908; // UWorld (Dumped With UDMANS Offset Dumper)
    }
    ...
    namespace AFortPickup {
        inline uintptr_t DefaultFlyTime = 0x5D4; // AFortPickup::DefaultFlyTime (Dumped With UDMANS Offset Dumper)
    ...
    namespace AFortWeapon {
        ...
        inline uintptr_t WeaponCoreAnimation = 0x1620; // AFortWeapon::WeaponCoreAnimation (Dumped With UDMANS Offset Dumper)
        inline uintptr_t WeaponData = 0x548; // AFortWeapon::WeaponData (Dumped With UDMANS Offset Dumper)
    ...
    namespace APlayerCameraManager {
        ...
        inline uintptr_t DefaultFOV = 0x2BC; // APlayerCameraManager::DefaultFOV (Dumped With UDMANS Offset Dumper)
    ...
    namespace FFortTrapStats {
        ...
        inline uintptr_t DamageDelay = 0x200; // FFortTrapStats::DamageDelay (Dumped With UDMANS Offset Dumper)
    ...
    namespace FMinimalViewInfo {
        ...
        inline uintptr_t DesiredFOV = 0x34; // FMinimalViewInfo::DesiredFOV (Dumped With UDMANS Offset Dumper)
...
#define CameraLocation      0x180        // Globals -> CameraLocation
#define CameraRotation      0x190 
namespace offsets {
